...
<t:dashboard_body>
	...
	<jsp:attribute name="contentHeader">
        ...
        <div class="col-xs-12">
            <div class="box-header">
              <h3 class="box-title ">Browse Teams</h3>
            </div>
          </div>
          </div>
	</jsp:attribute>
	...
	<div class="box box-success">
      <ul class="sidebar-menu">
           <li class="active"><a href="teams"><i class="fa fa-link"></i> <span>Teams</span></a></li>
		   <li class="treeview">
              <a href="#"><i class="fa fa-link"></i> <span>Teams Types</span><i class="fa fa-angle-down pull-up"></i></a>
              <ul class="treeview-menu">
                <li><a href="teams">Deveopment</a></li>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="issueTable">
                <tr>
                  ...
                  <th>Team Type</th>
                  <th>Category</th>
                  <th style="width: 200px">Team URL</th>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
